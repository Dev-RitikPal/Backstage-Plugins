...
export const UserMergeRequestsTable = gitlabPlugin.provide(
  createComponentExtension({
    name: 'UserMergeRequestsTable',
    component: {
      lazy: () =>
        import('./components/widgets/index').then(
          m => m.UserMergeRequestsTable,
        ),
    },
  }),
);

export const UserProjectPipelinesTable = gitlabPlugin.provide(
  createComponentExtension({
    name: 'UserProjectPipelinesTable',
    component: {
      lazy: () =>
        import('./components/widgets/index').then(
          m => m.UserProjectPipelinesTable,
        ),
    },
  }),
);
