...
export const DenseTable = ({
  ...
  // console.log('myToolkits', myToolkits.list);
  // const yourToolKit= [...yourToolkits.list]
  // const myToolKit= [...myToolkits.list]

  // const filteredData = myToolKit.filter(({ id }) => !yourToolKit.some((e) => e.id === id))
  ...
  /**
   * Setting columns based on checkable
   */
  useEffect(() => {
    // if (!toolkits?.value?.length && !toolkits?.loading && !toolkits.error) {
  ...
  /**
   * This function is used for deleting a tool
   * @param {number} id toolkit id
   */

  /**
   * handling the toolkit list
   */
