...
import { Progress, InfoCard, Page } from '@backstage/core-components';
import { Content } from '../SignInComponents/Content/Content';
import { ContentHeader } from '../SignInComponents/ContentHeader/ContentHeader';
import { Header } from '../SignInComponents/Header';
    ...
    <Page themeId="home">
      ...
      <Content>
        ...
        >
          ...
          >
            <a
              href="https://williamhill.slack.com/messages/cpe-portal-community/"
              target="_blank"
            >
              {' '}
              Contact Us!
